...
country = {
	...
	GOLD_TO_WORKER_PAY_RATE = 7, -- Multiplier for how much money gold pays to pops
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 0, -- base value that is powered by level of naval base. Determines the naval supplying capabilities.
	NAVAL_BASE_SUPPLY_SCORE_EMPTY = 0, -- min value for coastal provinces with no naval base.
	NAVAL_BASE_NON_CORE_SUPPLY_SCORE = 0, -- modifier for supply score for naval bases that are not in core provinces.
